                    ...
                    <nav id="main-nav-bar" class="navbar navbar-default">
                        <div class="container">
                            ...
                            <div class="navbar-header">
                                <a class="navbar-brand hidden-xs hidden-sm" href="homepage.php"><img alt="" src="../images/premium_logo"></a>
                            ...
                            <div class="collapse navbar-collapse navbar-right" id="navigation">
                                ...
                                <ul id="main-nav" class="nav navbar-nav">
                                    <li class="dropdown">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Produkte<span class="fa fa-angle-down"></span></a>
